...
commands = ["chance", "fail_queues", "fail-queues", "minimals", "score", "special_minimals", "special-minimals", "second_stats", "setup_stats", "all_setups", "help", "debug", "dpc_analyzer"]
for i in commands:
    f = open(i, "w")
    f.close()
...
def chance():
    ...
    print(f"The chance of solving the setup is {solverate}")
...
def minimals():
    ...
    system("py true_minimal.py > ezsfinder.txt")
    minimallink = open("ezsfinder.txt").read().splitlines()[1]
    print(f"The normal minimals are {minimallink}")
...
def special_minimals():
    ...
    system("py true_minimal.py > ezsfinder.txt")
    minimallink = open("ezsfinder.txt").read().splitlines()[1]
    print(f"The {minimal_type} minimals are {minimallink}")
